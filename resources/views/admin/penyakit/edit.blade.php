...
@section('content')
    <section id="dashboard-admin" class="mt-4 me-3">
        <div class="card p-3">
            <div class="card-body">
                <h1 class="text-center">Penyakit-Solusi Edit</h1>
                <div class="mt-4">
                    <form action="{{ route('penyakit_solusi_admin.update', $penyakit->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="definisi" id="definisi" cols="30" rows="7" class="form-control">{{$penyakit->definisi}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="solusi" class="col-sm-2 col-form-label">Solusi</label>
                            <div class="col-sm-10">
                                <textarea name="solusi" id="solusi" cols="30" rows="7" class="form-control">{{$penyakit->solusi}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tindak_lanjut" class="col-sm-2 col-form-label">tindak lanjut</label>
                            <div class="col-sm-10">
                                <textarea name="tindak_lanjut" id="tindak_lanjut" cols="30" rows="7" class="form-control">{{$penyakit->tindak_lanjut}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="obat" class="col-sm-2 col-form-label">Obat</label>
                            <div class="col-sm-10">
                                <textarea name="obat" id="obat" cols="30" rows="7" class="form-control">{{$penyakit->obat}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="priority" id="priority" type="number" class="form-control"
                                    value="{{ $penyakit->priority }}" required>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('penyakit_solusi_admin.index') }}" class="btn btn-danger me-2">cancel</a>
