        ...
        <div class="container">
            <div class="row space-100">
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="contents">
                        <h2 class="head-title">Welcome to Sipaklam</h2>
                        <p>Sistem Pakar Diagnosa Penyakit Lambung Menggunakan Metode Fuzzy Mamdani</p>
                        <div class="header-button">
                            <a href="https://deepublishstore.com/blog/sistem-pakar/" rel="nofollow" target="_blank"
                                class="btn btn-border-filled">Sistem Pakar</a>
                            <a href="https://journal.ittelkom-pwt.ac.id/index.php/inista/article/view/1057/335"
                                rel="nofollow" target="_blank" class="btn btn-border page-scroll">Jurnal</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row featured-bg">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 p-0">
                    ...
                    <div class="feature-item featured-border1">
                        ...
                        <div class="feature-info float-left">
                            <h4>Mendiagnosa Penyakit Berdasarkan Gejala</h4>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 p-0">
                    ...
                    <div class="feature-item featured-border2">
                        ...
                        <div class="feature-info float-left">
                            <h4>Kemudahan Dalam Periksa Secara Online </h4>
                            <!-- <p>Producing long lasting organic SEO results for <br> brand of different kinds for more than a
                                decade,<br> we understand that’s your.</p> -->
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 p-0">
                    ...
                    <div class="feature-item featured-border1">
                        ...
                        <div class="feature-info float-left">
                            <h4>Memberikan Informasi Penanganan Penyakit Lambung</h4>
                            <!-- <p>Producing long lasting organic SEO results for <br> brand of different kinds for more than a
                                decade,<br> we understand that’s your.</p> -->
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 p-0">
                    ...
                    <div class="feature-item featured-border2">
                        ...
                        <div class="feature-info float-left">
                            <h4>Memberikan Informasi Tentang Penyakit Lambung</h4>
                            <!-- <p>Producing long lasting organic SEO results for <br> brand of different kinds for more than a
                                decade,<br> we understand that’s your.</p>
                        </div> -->
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                        <div class="widget">
                            <h3 class="block-title">Rumah Sakit</h3>
                            <p>Jl Jend.Sudirman No 181 kelurahan Brebes, Kecamatan Brebes Kabupaten Brebes 52122 Fax.
                                (0283) 671095 Email : humas.rsudbrebes@gmail.com <br> (0283) 671431 atau 0858 0317 6936
                            </p>
                        </div>
                    </div>
                    <!-- End Col -->
