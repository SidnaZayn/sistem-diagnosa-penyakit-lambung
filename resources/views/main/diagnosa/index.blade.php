                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('diagnosa.createPasien') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="umur" value="<?php echo $row['age']; ?>" id="umur"
                                    type="text" size="2" maxlength="3" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-2 col-form-label">Alamat</label>
                            <div class="col-sm-10">
                                <input class="form-control" name="alamat" value="<?php echo $row['alamat']; ?>" id="alamat"
                                    required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="email" value="<?php echo $row['email']; ?>" id="email"
                                    required>
                            </div>
                        </div>
                </div>
